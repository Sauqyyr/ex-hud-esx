...
RegisterCommand('shiftalert', function()
    ...
    if beepSoundEnabled then
        ...
        TriggerEvent('esx:showNotification', 'Shift alert sound enabled', 1)
    else
        --[[TriggerEvent('chat:addMessage', {
            color = { 255, 0, 0},
            multiline = true,
        ...
        TriggerEvent('esx:showNotification', 'Shift alert sound disabled', 2)
    end
end, false)
...
--[[CreateThread(function()
    while true do
        Wait(0) -- This loop runs every frame
